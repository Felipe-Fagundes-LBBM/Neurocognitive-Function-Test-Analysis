...
plot1 + stat_compare_means(method = "t.test")
...
plot2 + stat_compare_means(method = "t.test" , label.y = 110, label.x = 1.1)
...
plot5 + stat_compare_means(method = "t.test" , label.y = 18, label.x = 1.1)
